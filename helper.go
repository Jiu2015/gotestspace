...
func NewTestSpaceCommand(ctx context.Context, path string, env []string, stdin io.Reader, stdout, stderr io.Writer,
	...
	spaceCommand, err := new(ctx, cmd, stdin, stdout, stderr, env...)
	if err != nil {
		return nil, err
	}
